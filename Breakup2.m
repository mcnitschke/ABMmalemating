function[FM,FG,M,G,FMm,FGg,FGm,FMg,PGg,PG,PMm,PMg,PM]...
    =Breakup2(FM,FG,M,G,FMm,FGg,FGm,FMg,PGg,PG,PMm,PMg,PM,chi)
...
%     Prow = randsample(numel(Pa),1);
%     Pcol = randsample(numel(Pb),1);
...
%     Pg_row = randsample(numel(Pga),1);
%     Pg_col = randsample(numel(Pgb),1);
%     Pg_z = randsample(numel(Pgc),1);
% NOT FULLY RANDOM!  I always take the oldest couple to breakup
