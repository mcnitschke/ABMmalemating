function[FM,FG,M,G,FMm,FGg,FGm,FMg,PGg,PG,PMm,PMg,PM,X,Xg,Xm,JMm,JGm,JMf,JGf,MP,GP]=...
    AgingMaturation2(q_star,FM,FG,M,G,FMm,FGg,FGm,FMg,PGg,PG,PMm,PMg,PM,X,Xg,Xm,JMm,JGm,JMf,JGf)
...
%Aging of full population  !!ERROR HERE....update FM/FG/M/G first!!
...
Xg(1,:) = 0;
Xg(:,1) = 0;
%Temp = squeeze(sum(PMg,2)+sum(PGg,2));
